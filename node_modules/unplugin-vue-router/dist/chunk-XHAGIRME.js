...
function getPascalCaseRouteName(node) {
  if (_optionalChain([node, 'access', _ => _.parent, 'optionalAccess', _2 => _2.isRoot, 'call', _3 => _3()]) && node.value.pathSegment === "")
    return "Root";
...
exports.warn = warn; exports.logTree = logTree; exports.trimExtension = trimExtension; exports.throttle = throttle; exports.joinPath = joinPath; exports.getPascalCaseRouteName = getPascalCaseRouteName; exports.getFileBasedRouteName = getFileBasedRouteName; exports.mergeRouteRecordOverride = mergeRouteRecordOverride; exports.asRoutePath = asRoutePath; exports.appendExtensionListToPattern = appendExtensionListToPattern; exports.ImportsMap = ImportsMap; exports.DEFAULT_OPTIONS = DEFAULT_OPTIONS; exports.resolveOptions = resolveOptions;
