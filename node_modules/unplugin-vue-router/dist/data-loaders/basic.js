"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }// src/data-loaders/defineLoader.ts
...
function defineBasicLoader(nameOrLoader, _loaderOrOptions, opts) {
  ...
  function load(to, router, parent) {
    ...
    const currentLoad = Promise.resolve(
      loader(to, { signal: to.meta[_runtime.ABORT_CONTROLLER_KEY].signal })
    ).then((d) => {
  ...
  const useDataLoader = () => {
    const [parentEntry, _router, _route] = _runtime.getCurrentContext.call(void 0, );
    ...
    if (
      ...
      router[_runtime.APP_KEY].runWithContext(() => load(route, router, parentEntry));
    }
